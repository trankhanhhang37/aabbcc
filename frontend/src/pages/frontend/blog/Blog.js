      ...
      <main role="main" class="container">
        <div class="row">
          <div class="col-md-12 blog-main">
            ...
            <header class="mb-4">
              <h3>Blog posts</h3>
              <button onClick={() => onChangeTopic("")} type="button" class="btn btn-rounded" style={{ backgroundColor: '#f6831f', color: 'white' }} data-mdb-ripple-init >Tất cả bài viết</button>
              {allTopic && allTopic.map((topic, index) => {
                return <button onClick={() => onChangeTopic(topic._id)} type="button" class="btn btn-rounded" style={{ backgroundColor: '#f6831f', color: 'white' }} data-mdb-ripple-init key={index} >{topic.topic_name}</button>
              })}
            </header>
